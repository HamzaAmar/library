...
const login = () => {
  const { signin, signinWithGoogle, signinWithFacebook } = useProvideAuth();
  ...
  const gmailProvider = async () => {
    console.log('gmailProvider signinWithGoogle()');
    try {
